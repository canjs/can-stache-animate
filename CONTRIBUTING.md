# Contributing to can-stache-animate

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/canjs/can-stache-animate) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-stache-animate, you can start by going to its [fork page](https://github.com/canjs/can-stache-animate/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-stache-animate
```
